...
- [~~Fade music in~~](http://wiki.bennugd.org/index.php?title=Fade_music_in "Fade music in") -> [`fade_music_in()`]({{< ref "fade_music_in" >}})
- [~~Fade music off~~](http://wiki.bennugd.org/index.php?title=Fade_music_off "Fade music off") -> [`fade_music_off()`]({{< ref "fade_music_off" >}})
...
- [~~Is playing song~~](http://wiki.bennugd.org/index.php?title=Is_playing_song "Is playing song") -> [`is_playing_song()`]({{< ref "is_playing_song" >}})
- [~~Is playing wav~~](http://wiki.bennugd.org/index.php?title=Is_playing_wav "Is playing wav") -> [`is_playing_wav()`]({{< ref "is_playing_wav" >}})
...
- [~~Load Song~~](http://wiki.bennugd.org/index.php?title=Load_Song "Load Song") -> [`load_song()`]({{< ref "load_song" >}})
...
- [~~Load wav~~](http://wiki.bennugd.org/index.php?title=Load_wav "Load wav") -> [`load_wav()`]({{< ref "load_wav" >}})
...
- [~~Memseti~~](http://wiki.bennugd.org/index.php?title=Memseti "Memseti") -> [`memset()`]({{< ref "/docs/functions/memset" >}})
...
- [~~OS BEOS~~](http://wiki.bennugd.org/index.php?title=OS_BEOS "OS BEOS") -> [`Constants/os_codes`]({{< ref "/docs/constants/os_codes" >}})
- [~~OS BSD~~](http://wiki.bennugd.org/index.php?title=OS_BSD "OS BSD") -> [`Constants/os_codes`]({{< ref "/docs/constants/os_codes" >}})
- [~~OS DC~~](http://wiki.bennugd.org/index.php?title=OS_DC "OS DC") -> [`Constants/os_codes`]({{< ref "/docs/constants/os_codes" >}})
- [~~OS GP2X~~](http://wiki.bennugd.org/index.php?title=OS_GP2X "OS GP2X") -> [`Constants/os_codes`]({{< ref "/docs/constants/os_codes" >}})
- [~~OS GP32~~](http://wiki.bennugd.org/index.php?title=OS_GP32 "OS GP32") -> [`Constants/os_codes`]({{< ref "/docs/constants/os_codes" >}})
- [~~OS LINUX~~](http://wiki.bennugd.org/index.php?title=OS_LINUX "OS LINUX") -> [`Constants/os_codes`]({{< ref "/docs/constants/os_codes" >}})
- [~~OS MACOS~~](http://wiki.bennugd.org/index.php?title=OS_MACOS "OS MACOS") -> [`Constants/os_codes`]({{< ref "/docs/constants/os_codes" >}})
- [~~OS WII~~](http://wiki.bennugd.org/index.php?title=OS_WII "OS WII") -> [`Constants/os_codes`]({{< ref "/docs/constants/os_codes" >}})
- [~~OS WIN32~~](http://wiki.bennugd.org/index.php?title=OS_WIN32 "OS WIN32") -> [`Constants/os_codes`]({{< ref "/docs/constants/os_codes" >}})
- [~~OS codes~~](http://wiki.bennugd.org/index.php?title=OS_codes "OS codes") -> [`Constants/os_codes`]({{< ref "/docs/constants/os_codes" >}})
...
- [Onexit](http://wiki.bennugd.org/index.php?title=Onexit "Onexit")
- [~~Operator~~](http://wiki.bennugd.org/index.php?title=Operator "Operator") -> [`Operators`]({{< ref "/docs/language/operators" >}})
- [~~Operators~~](http://wiki.bennugd.org/index.php?title=Operators "Operators") -> [`Operators`]({{< ref "/docs/language/operators" >}})
...
- [~~PI~~](http://wiki.bennugd.org/index.php?title=PI "PI") -> [`Constants/PI`]({{< ref "/docs/constants/pi" >}})
...
- [~~Pow~~](http://wiki.bennugd.org/index.php?title=Pow "Pow") -> [`pow()`]({{< ref "/docs/functions/pow" >}})
...
- [~~Process~~](http://wiki.bennugd.org/index.php?title=Process "Process") -> [`Language/Process`]({{< ref "process" >}})
...
- [~~Process statuscodes~~](http://wiki.bennugd.org/index.php?title=Process_statuscodes "Process statuscodes") -> [`Constants/Process Statuscodes`]({{< ref "/docs/constants/process_statuscodes" >}})
- [~~Processes~~](http://wiki.bennugd.org/index.php?title=Processes "Processes") -> [`Language/Process`]({{< ref "process" >}})
- [Processid](http://wiki.bennugd.org/index.php?title=Processid "Processid")
- [Processtype](http://wiki.bennugd.org/index.php?title=Processtype "Processtype")
...
- [~~Realloc~~](http://wiki.bennugd.org/index.php?title=Realloc "Realloc") -> [`realloc()`]({{< ref "/docs/functions/realloc" >}})
...
- [~~STATUS DEAD~~](http://wiki.bennugd.org/index.php?title=STATUS_DEAD "STATUS DEAD") -> [`Constants/Process Statuscodes`]({{< ref "/docs/constants/process_statuscodes" >}})
- [~~STATUS FROZEN~~](http://wiki.bennugd.org/index.php?title=STATUS_FROZEN "STATUS FROZEN") -> [`Constants/Process Statuscodes`]({{< ref "/docs/constants/process_statuscodes" >}})
- [~~STATUS KILLED~~](http://wiki.bennugd.org/index.php?title=STATUS_KILLED "STATUS KILLED") -> [`Constants/Process Statuscodes`]({{< ref "/docs/constants/process_statuscodes" >}})
- [~~STATUS RUNNING~~](http://wiki.bennugd.org/index.php?title=STATUS_RUNNING "STATUS RUNNING") -> [`Constants/Process Statuscodes`]({{< ref "/docs/constants/process_statuscodes" >}})
- [~~STATUS SLEEPING~~](http://wiki.bennugd.org/index.php?title=STATUS_SLEEPING "STATUS SLEEPING") -> [`Constants/Process Statuscodes`]({{< ref "/docs/constants/process_statuscodes" >}})
- [~~STATUS WAITING~~](http://wiki.bennugd.org/index.php?title=STATUS_WAITING "STATUS WAITING") -> [`Constants/Process Statuscodes`]({{< ref "/docs/constants/process_statuscodes" >}})
...
- [~~Set center~~](http://wiki.bennugd.org/index.php?title=Set_center "Set center") -> [`center_set()`]({{< ref "/docs/functions/center_set" >}})
...
- [~~Sin~~](http://wiki.bennugd.org/index.php?title=Sin "Sin") -> [`sin()`]({{< ref "/docs/functions/sin" >}})
...
- [~~Sizeof~~](http://wiki.bennugd.org/index.php?title=Sizeof "Sizeof") -> [`sizeof()`]({{< ref "/docs/language/sizeof" >}})
...
- [~~Sqrt~~](http://wiki.bennugd.org/index.php?title=Sqrt "Sqrt") -> [`sqrt()`]({{< ref "/docs/functions/sqrt" >}})
...
- [~~TRUE~~](http://wiki.bennugd.org/index.php?title=TRUE "TRUE") -> [`Constants/TRUE`]({{< ref "/docs/constants/true" >}})
...
- [~~Tan~~](http://wiki.bennugd.org/index.php?title=Tan "Tan") -> [`tan()`]({{< ref "/docs/functions/tan" >}})
...
- [~~Text height~~](http://wiki.bennugd.org/index.php?title=Text_height "Text height") -> [`text_height()`]({{< ref "/docs/functions/text_height" >}})
- [~~Text width~~](http://wiki.bennugd.org/index.php?title=Text_width "Text width") -> [`text_width()`]({{< ref "/docs/functions/text_width" >}})
...
- [~~Value~~](http://wiki.bennugd.org/index.php?title=Value "Value") -> [`Language/Value`]({{< ref "/docs/language/value" >}})
- [~~Variable~~](http://wiki.bennugd.org/index.php?title=Variable "Variable") -> [`Language/Variable`]({{< ref "/docs/language/variable" >}})
...
- [~~Write~~](http://wiki.bennugd.org/index.php?title=Write "Write") -> [`write()`]({{< ref "/docs/functions/write" >}})
